...
project = 'JAXAtari'
copyright = '2026 Quentin Delfosse, Jannis Blüml'
...
exclude_patterns = ['_build', 'Thumbs.db', '.DS_Store', 'scripts', 'tests']
...
html_title = 'JAXAtari Documentation'
html_theme = 'furo'
html_theme_options = {
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/k4ntz/JAXAtari",
