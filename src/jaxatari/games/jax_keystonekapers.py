...
def _get_default_asset_config() -> tuple:
    """Returns the default asset configuration for KeystoneKapers."""
    return (
        {'name': 'activision_logo', 'type': 'single', 'file': 'activision logo.npy'},
        {'name': 'ball_air', 'type': 'single', 'file': 'ball_air.npy'},
        {'name': 'ball_bounce', 'type': 'single', 'file': 'ball_bounce.npy'},
        {'name': 'black_digits', 'type': 'digits', 'pattern': 'black_{}.npy'},
        {'name': 'white_digits', 'type': 'digits', 'pattern': 'white_{}.npy'},
        {'name': 'blue_enemy', 'type': 'single', 'file': 'blue_enemy.npy'},
        {'name': 'elevator_closed', 'type': 'single', 'file': 'elevator_closed.npy'},
        {'name': 'elevator_open', 'type': 'single', 'file': 'elevator_open.npy'},
        {'name': 'escalator_left_floor_1', 'type': 'group', 'files': [
            'escalator_left_facing_floor_1_1.npy',
            'escalator_left_facing_floor_1_2.npy',
            'escalator_left_facing_floor_1_3.npy',
            'escalator_left_facing_floor_1_4.npy'
        ]},
        {'name': 'escalator_left_floor_3', 'type': 'group', 'files': [
            'escalator_left_facing_floor_3_1.npy',
            'escalator_left_facing_floor_3_2.npy',
            'escalator_left_facing_floor_3_3.npy',
            'escalator_left_facing_floor_3_4.npy'
        ]},
        {'name': 'escalator_right', 'type': 'group', 'files': [
            'escalator_right_facing_1.npy',
            'escalator_right_facing_2.npy',
            'escalator_right_facing_3.npy',
            'escalator_right_facing_4.npy'
        ]},
        {'name': 'kop_left_run', 'type': 'group', 'files': [
            'kop_facing_left_run_frame_1.npy',
            'kop_facing_left_run_frame_2.npy',
            'kop_facing_left_run_frame_3.npy',
            'kop_facing_left_run_frame_4.npy'
        ]},
        {'name': 'kop_right_standing', 'type': 'single', 'file': 'kop_facing_right_standing.npy'},
        {'name': 'kop_life', 'type': 'single', 'file': 'kop_life.npy'},
        {'name': 'kop_run', 'type': 'group', 'files': ['kop_run_1.npy', 'kop_run_2.npy']},
        {'name': 'kop_standing', 'type': 'single', 'file': 'kop_standing.npy'},
        {'name': 'money_bag', 'type': 'single', 'file': 'money_bag.npy'},
        {'name': 'obstacle', 'type': 'single', 'file': 'obstacle.npy'},
        {'name': 'pillars_section', 'type': 'single', 'file': 'pillars_section.npy'},
        {'name': 'shoppingkart', 'type': 'single', 'file': 'shoppingkart.npy'},
        {'name': 'sky_and_buildings', 'type': 'single', 'file': 'sky_and_buildings.npy'},
        {'name': 'small_box', 'type': 'single', 'file': 'small_box.npy'},
        {'name': 'suitcase', 'type': 'single', 'file': 'suitcase.npy'},
        {'name': 'thief_run_right', 'type': 'group', 'files': [
            'thief_run_right_1.npy',
            'thief_run_right_2.npy',
            'thief_run_right_3.npy',
            'thief_run_right_4.npy'
        ]},
        {'name': 'wide_box', 'type': 'single', 'file': 'wide_box.npy'},
    )


class KeystoneKapersConstants(AutoDerivedConstants):
    """Game constants and configuration parameters."""
    TOTAL_SCREEN_WIDTH: int = struct.field(pytree_node=False, default=160)
    TOTAL_SCREEN_HEIGHT: int = struct.field(pytree_node=False, default=250)
    GAME_AREA_WIDTH: int = struct.field(pytree_node=False, default=152)
    GAME_AREA_HEIGHT: int = struct.field(pytree_node=False, default=177)
    GAME_AREA_OFFSET_X: int = struct.field(pytree_node=False, default=8)
    GAME_AREA_OFFSET_Y: int = struct.field(pytree_node=False, default=29)
    SCREEN_WIDTH: int = struct.field(pytree_node=False, default=152)
    SCREEN_HEIGHT: int = struct.field(pytree_node=False, default=177)
    BUILDING_SECTIONS: int = struct.field(pytree_node=False, default=7)
    SECTION_WIDTH: int = struct.field(pytree_node=False, default=152)
    TOTAL_BUILDING_WIDTH: int = struct.field(pytree_node=False, default=1064)
    FLOOR_1_Y: int = struct.field(pytree_node=False, default=132)
    FLOOR_2_Y: int = struct.field(pytree_node=False, default=100)
    FLOOR_3_Y: int = struct.field(pytree_node=False, default=68)
    ROOF_Y: int = struct.field(pytree_node=False, default=36)
    FLOOR_HEIGHT: int = struct.field(pytree_node=False, default=26)
    MINIMAP_HEIGHT: int = struct.field(pytree_node=False, default=35)
    MINIMAP_COLOR: Tuple[int, int, int] = struct.field(pytree_node=False, default=(151, 151, 151))
    MINIMAP_DISPLAY_WIDTH: int = struct.field(pytree_node=False, default=100)
    MINIMAP_DISPLAY_HEIGHT: int = struct.field(pytree_node=False, default=16)
    MINIMAP_DISPLAY_OFFSET_X: int = struct.field(pytree_node=False, default=26)
    MINIMAP_DISPLAY_OFFSET_Y: int = struct.field(pytree_node=False, default=2)
    MINIMAP_TAN: Tuple[int, int, int] = struct.field(pytree_node=False, default=(190, 156, 72))
    MINIMAP_YELLOW: Tuple[int, int, int] = struct.field(pytree_node=False, default=(207, 175, 92))
    MINIMAP_DARK_TAN: Tuple[int, int, int] = struct.field(pytree_node=False, default=(171, 135, 50))
    MINIMAP_GREEN: Tuple[int, int, int] = struct.field(pytree_node=False, default=(50, 152, 82))
    ESCALATOR_1_OFFSET: int = struct.field(pytree_node=False, default=40)
    ESCALATOR_2_OFFSET: int = struct.field(pytree_node=False, default=120)
    ESCALATOR_WIDTH: int = struct.field(pytree_node=False, default=16)
    ESCALATOR_HEIGHT: int = struct.field(pytree_node=False, default=25)
    ESCALATOR_COLOR: Tuple[int, int, int] = struct.field(pytree_node=False, default=(52, 0, 128))
    ESCALATOR_STEP_COLOR: Tuple[int, int, int] = struct.field(pytree_node=False, default=(255, 255, 255))
    ESCALATOR_ANIMATION_SPEED: int = struct.field(pytree_node=False, default=32)
    ESCALATOR_FLOOR1_X: int = struct.field(pytree_node=False, default=76)
    ESCALATOR_FLOOR2_X: int = struct.field(pytree_node=False, default=968)
    ESCALATOR_FLOOR3_X: int = struct.field(pytree_node=False, default=76)
    ELEVATOR_BUILDING_X: int = struct.field(pytree_node=False, default=520)
    ELEVATOR_WIDTH: int = struct.field(pytree_node=False, default=16)
    ELEVATOR_MOVE_TIME: int = struct.field(pytree_node=False, default=120)
    ELEVATOR_DOOR_TIME: int = struct.field(pytree_node=False, default=60)
    ELEVATOR_WAIT_TIME: int = struct.field(pytree_node=False, default=180)
    PLAYER_WIDTH: int = struct.field(pytree_node=False, default=8)
    PLAYER_HEIGHT: int = struct.field(pytree_node=False, default=16)
    PLAYER_CROUCH_HEIGHT: int = struct.field(pytree_node=False, default=8)
    PLAYER_SPEED: int = struct.field(pytree_node=False, default=2)
    JUMP_HEIGHT: int = struct.field(pytree_node=False, default=12)
    JUMP_DURATION: int = struct.field(pytree_node=False, default=20)
    JUMP_GRAVITY: float = struct.field(pytree_node=False, default=0.8)
    THIEF_WIDTH: int = struct.field(pytree_node=False, default=8)
    THIEF_HEIGHT: int = struct.field(pytree_node=False, default=16)
    THIEF_BASE_SPEED: float = struct.field(pytree_node=False, default=0.75)
    THIEF_SPEED_SCALE: float = struct.field(pytree_node=False, default=0.08)
    THIEF_MAX_SPEED: float = struct.field(pytree_node=False, default=1.8)
    CART_WIDTH: int = struct.field(pytree_node=False, default=12)
    CART_HEIGHT: int = struct.field(pytree_node=False, default=8)
    CART_BASE_SPEED: float = struct.field(pytree_node=False, default=1.5)
    CART_SPEED_SCALE: float = struct.field(pytree_node=False, default=0.08)
    CART_MIN_SPAWN_INTERVAL: float = struct.field(pytree_node=False, default=1.5)
    CART_MAX_SPAWN_INTERVAL: float = struct.field(pytree_node=False, default=3.0)
    BALL_WIDTH: int = struct.field(pytree_node=False, default=6)
    BALL_HEIGHT: int = struct.field(pytree_node=False, default=6)
    BALL_BASE_SPEED: float = struct.field(pytree_node=False, default=2.5)
    BALL_BOUNCE_HEIGHT: int = struct.field(pytree_node=False, default=3)
    BALL_MIN_SPAWN_INTERVAL: float = struct.field(pytree_node=False, default=0.3)
    BALL_MAX_SPAWN_INTERVAL: float = struct.field(pytree_node=False, default=1.2)
    BALL_GRAVITY: float = struct.field(pytree_node=False, default=0.6)
    BALL_TIME_PENALTY: int = struct.field(pytree_node=False, default=10)
    BALL_FREEZE_TIME: int = struct.field(pytree_node=False, default=24)
    PLANE_WIDTH: int = struct.field(pytree_node=False, default=16)
    PLANE_HEIGHT: int = struct.field(pytree_node=False, default=8)
    PLANE_BASE_SPEED: float = struct.field(pytree_node=False, default=3.0)
    PLANE_SPEED_SCALE: float = struct.field(pytree_node=False, default=0.12)
    PLANE_MIN_SPAWN_INTERVAL: float = struct.field(pytree_node=False, default=3.0)
    PLANE_MAX_SPAWN_INTERVAL: float = struct.field(pytree_node=False, default=6.0)
    OBSTACLE_WIDTH: int = struct.field(pytree_node=False, default=8)
    OBSTACLE_HEIGHT: int = struct.field(pytree_node=False, default=8)
    OBSTACLE_TIME_PENALTY: int = struct.field(pytree_node=False, default=600)
    MAX_STATIONARY_OBSTACLES: int = struct.field(pytree_node=False, default=4)
    SHOPPING_CART_WIDTH: int = struct.field(pytree_node=False, default=12)
    SHOPPING_CART_HEIGHT: int = struct.field(pytree_node=False, default=8)
    SHOPPING_CART_BASE_SPEED: float = struct.field(pytree_node=False, default=1.8)
    SHOPPING_CART_SPEED_SCALE: float = struct.field(pytree_node=False, default=0.08)
    SHOPPING_CART_MIN_SPAWN_INTERVAL: float = struct.field(pytree_node=False, default=2.0)
    SHOPPING_CART_MAX_SPAWN_INTERVAL: float = struct.field(pytree_node=False, default=4.0)
    SHOPPING_CART_TIME_PENALTY: int = struct.field(pytree_node=False, default=600)
    MAX_SHOPPING_CARTS: int = struct.field(pytree_node=False, default=3)
    OBSTACLE_TYPE_STATIONARY: int = struct.field(pytree_node=False, default=0)
    OBSTACLE_TYPE_SHOPPING_CART: int = struct.field(pytree_node=False, default=1)
    ITEM_WIDTH: int = struct.field(pytree_node=False, default=8)
    ITEM_HEIGHT: int = struct.field(pytree_node=False, default=8)
    BASE_TIMER: int = struct.field(pytree_node=False, default=3600)
    TIMER_REDUCTION_PER_LEVEL: int = struct.field(pytree_node=False, default=300)
    COLLISION_PENALTY: int = struct.field(pytree_node=False, default=300)
    CATCH_THIEF_POINTS: int = struct.field(pytree_node=False, default=0)
    TIME_BONUS_MULTIPLIER: int = struct.field(pytree_node=False, default=100)
    ITEM_POINTS: int = struct.field(pytree_node=False, default=50)
    JUMP_POINTS: int = struct.field(pytree_node=False, default=0)
    EXTRA_LIFE_THRESHOLD: int = struct.field(pytree_node=False, default=10000)
    OBSTACLE_SPAWN_SCALE: float = struct.field(pytree_node=False, default=0.12)
    MAX_OBSTACLES: int = struct.field(pytree_node=False, default=8)
    MAX_ITEMS: int = struct.field(pytree_node=False, default=4)
    ITEM_TYPE_MONEYBAG: int = struct.field(pytree_node=False, default=0)
    ITEM_TYPE_SUITCASE: int = struct.field(pytree_node=False, default=1)
    BACKGROUND_COLOR: Tuple[int, int, int] = struct.field(pytree_node=False, default=(50, 152, 82))
    PLAYER_COLOR: Tuple[int, int, int] = struct.field(pytree_node=False, default=(0, 255, 0))
    THIEF_COLOR: Tuple[int, int, int] = struct.field(pytree_node=False, default=(255, 255, 0))
    FLOOR_TAN_COLOR: Tuple[int, int, int] = struct.field(pytree_node=False, default=(190, 156, 72))
    FLOOR_YELLOW_COLOR: Tuple[int, int, int] = struct.field(pytree_node=False, default=(207, 175, 92))
    ESCALATOR_COLOR: Tuple[int, int, int] = struct.field(pytree_node=False, default=(128, 128, 128))
    ELEVATOR_COLOR: Tuple[int, int, int] = struct.field(pytree_node=False, default=(64, 64, 64))
    CART_COLOR: Tuple[int, int, int] = struct.field(pytree_node=False, default=(255, 0, 0))
    BALL_COLOR: Tuple[int, int, int] = struct.field(pytree_node=False, default=(255, 255, 255))
    PLANE_COLOR: Tuple[int, int, int] = struct.field(pytree_node=False, default=(255, 165, 0))
    ITEM_COLOR: Tuple[int, int, int] = struct.field(pytree_node=False, default=(255, 0, 255))
...
class PlayerState:
    ...
    jump_start_y: chex.Array
    freeze_timer: chex.Array
    on_escalator: chex.Array
    escalator_progress: chex.Array
    is_on_elevator: chex.Array
    in_elevator: chex.Array
...
class ObstacleState:
    ...
    ball_floor: chex.Array
    ball_is_bouncing: chex.Array
    plane_x: chex.Array
    plane_y: chex.Array
...
class ElevatorState:
    ...
    state: chex.Array
    timer: chex.Array
    target_floor: chex.Array
    has_player: chex.Array


@struct.dataclass
class KeystoneKapersState:
    """Complete game state."""
    player: PlayerState
    thief: ThiefState
...
@struct.dataclass
class KeystoneKapersObservation:
    """Observation space for the agent."""
    player: ObjectObservation
    thief: ObjectObservation
    obstacle_positions: chex.Array
    item_positions: chex.Array
    score: chex.Array
    timer: chex.Array
    level: chex.Array
    lives: chex.Array
...
class JaxKeystoneKapers(JaxEnvironment[KeystoneKapersState, KeystoneKapersObservation, KeystoneKapersInfo, KeystoneKapersConstants]):
    ...
    def __init__(self, consts: KeystoneKapersConstants = None):
        consts = consts or KeystoneKapersConstants()
    ...
    @partial(jax.jit, static_argnums=(0,))
    def _update_player(self, state: KeystoneKapersState, action: chex.Array) -> PlayerState:
    ...
    @partial(jax.jit, static_argnums=(0,))
    def _update_thief(self, state: KeystoneKapersState) -> ThiefState:
    ...
    @partial(jax.jit, static_argnums=(0,))
    def _update_elevator(self, state: KeystoneKapersState, action: chex.Array) -> ElevatorState:
    ...
    @partial(jax.jit, static_argnums=(0,))
    def _spawn_obstacle(self, key: chex.PRNGKey, state: KeystoneKapersState, obstacle_type: int) -> ObstacleState:
    ...
    @partial(jax.jit, static_argnums=(0,))
    def _update_obstacles(self, state: KeystoneKapersState, key: chex.PRNGKey) -> ObstacleState:
        ...
        obstacles_after_ball_spawn = jax.lax.cond(
            ...
            lambda: self._spawn_obstacle(ball_spawn_key, state.replace(obstacles=obstacles_with_updates), 1),
        ...
        return obstacles_after_ball_spawn.replace(ball_spawn_timer=final_ball_spawn_timer)
    ...
    @partial(jax.jit, static_argnums=(0,))
    def _spawn_stationary_obstacles(self, state: KeystoneKapersState, key: chex.PRNGKey) -> Tuple[chex.Array, chex.Array, chex.Array, chex.Array]:
    ...
    @partial(jax.jit, static_argnums=(0,))
    def _update_shopping_carts(self, state: KeystoneKapersState, key: chex.PRNGKey) -> KeystoneKapersState:
    ...
    @partial(jax.jit, static_argnums=(0,))
    def _check_collisions(self, state: KeystoneKapersState) -> Tuple[bool, bool, bool, int, chex.Array]:
    ...
    @partial(jax.jit, static_argnums=(0,))
    def reset(self, key: chex.PRNGKey = jax.random.PRNGKey(42)) -> Tuple[KeystoneKapersObservation, KeystoneKapersState]:
        """Reset the game to initial state with building traversal setup."""
        state_key, item_key = jax.random.split(key)

        # Initialize player at rightmost section of ground floor (as per original game)
        player_start_x = self.consts.TOTAL_BUILDING_WIDTH - 78
        player = PlayerState(
            x=jnp.array(player_start_x),
            y=jnp.array(self.consts.FLOOR_1_Y + 2),
            floor=jnp.array(0),
            vel_x=jnp.array(0),
            vel_y=jnp.array(0),
            ...
            jump_start_y=jnp.array(self.consts.FLOOR_1_Y + 2),
        ...
        thief = ThiefState(
            ...
            y=jnp.array(self.consts.FLOOR_2_Y + 2),
            floor=jnp.array(1),
        ...
        obstacles = ObstacleState(
            ...
            ball_spawn_timer=jnp.array(45),
            ball_floor=jnp.zeros(self.consts.MAX_OBSTACLES, dtype=jnp.int32),
            ball_is_bouncing=jnp.zeros(self.consts.MAX_OBSTACLES, dtype=bool),
            ...
            plane_spawn_timer=jnp.array(180)
        )
        ...
        state = KeystoneKapersState(
            ...
            shopping_cart_direction=jnp.ones(self.consts.MAX_SHOPPING_CARTS, dtype=jnp.int32),
            shopping_cart_spawn_timer=jnp.array(120),
    ...
    @partial(jax.jit, static_argnums=(0,))
    def step(self, state: KeystoneKapersState, action: chex.Array) -> Tuple[KeystoneKapersObservation, KeystoneKapersState, float, bool, KeystoneKapersInfo]:
        """Step the environment forward by one frame with camera updates."""
        # Split key for this step
        key, step_key = jrandom.split(state.key)
        
        # Convert action index to actual Atari action
        atari_action = jnp.take(self.ACTION_SET, action.astype(jnp.int32))

        # Update all game components
        new_player = self._update_player(state, atari_action)
        new_thief = self._update_thief(state)
        new_elevator = self._update_elevator(state, atari_action)
        new_obstacles = self._update_obstacles(state, step_key)

        # Update shopping carts
        updated_state = self._update_shopping_carts(state.replace(
            player=new_player,
            thief=new_thief,
        ...
        new_obstacles = new_obstacles.replace(ball_active=new_ball_active)
        ...
        player_with_freeze = new_player.replace(freeze_timer=new_freeze_timer)
        ...
        def spawn_stationary_obstacles():
            ...
            obs_x, obs_y, obs_active, obs_floor = self._spawn_stationary_obstacles(
                updated_state.replace(thief_caught=True), obstacle_key
            )
    ...
    @partial(jax.jit, static_argnums=(0,))
    def _get_observation(self, state: KeystoneKapersState) -> KeystoneKapersObservation:
        """Extract observation from game state."""
        # Create object observations for player and thief
        ...
        thief_obs = ObjectObservation.create(
            x=state.thief.x,
            y=state.thief.y,
            width=jnp.array(self.consts.THIEF_WIDTH),
            height=jnp.array(self.consts.THIEF_HEIGHT),
            active=jnp.logical_not(state.thief.escaped)
        )
    ...
    def observation_space(self) -> spaces.Dict:
        ...
        return spaces.Dict({
            "player": spaces.get_object_space(),
            "thief": spaces.get_object_space(),
    ...
    @partial(jax.jit, static_argnums=(0,))
    def _get_info(self, state: KeystoneKapersState, all_rewards: chex.Array = None) -> KeystoneKapersInfo:
    ...
    @partial(jax.jit, static_argnums=(0,))
    def _get_reward(self, previous_state: KeystoneKapersState, state: KeystoneKapersState) -> float:
    ...
    @partial(jax.jit, static_argnums=(0,))
    def _get_all_rewards(self, previous_state: KeystoneKapersState, state: KeystoneKapersState) -> chex.Array:
        """Get all reward components."""
        return jnp.array([self._get_reward(previous_state, state)])

    @partial(jax.jit, static_argnums=(0,))
    def _get_done(self, state: KeystoneKapersState) -> bool:
    ...
    def render(self, state: KeystoneKapersState) -> jnp.ndarray:
...
class KeystoneKapersRenderer(JAXGameRenderer):
    ...
    def __init__(self, consts: KeystoneKapersConstants = None, config: render_utils.RendererConfig = None):
        self.consts = consts or KeystoneKapersConstants()
        super().__init__(self.consts)
        
        if config is None:
            self.config = render_utils.RendererConfig(
                game_dimensions=(self.consts.TOTAL_SCREEN_HEIGHT, self.consts.TOTAL_SCREEN_WIDTH),
                channels=3,
                downscale=None
            )
        else:
        ...
        self.sprite_dir = os.path.join(os.path.dirname(__file__), "sprites", "keystonekapers")
    ...
    def _create_simple_sprites(self) -> Dict[str, Any]:
        ...
        try:
            sky_sprite_path = os.path.join(self.sprite_dir, 'sky_and_buildings.npy')
            sky_sprite_rgba = self.self.jr.loadFrame(sky_sprite_path)
            ...
            sprites['sky'] = jnp.ones((40, 152, 3), dtype=jnp.uint8) * jnp.array([135, 206, 235], dtype=jnp.uint8)

        # Load the kop life sprite
        try:
            kop_life_sprite_path = os.path.join(self.sprite_dir, 'kop_life.npy')
            kop_life_sprite_rgba = self.self.jr.loadFrame(kop_life_sprite_path)
        ...
        for digit in range(10):  # Load all digits 0-9
            try:
                ...
                digit_sprite_rgba = self.jr.loadFrame(digit_sprite_path)
        ...
        try:
            ...
            activision_logo_rgba = self.jr.loadFrame(activision_logo_path)
        ...
        for sprite_prefix in sprite_prefixes:
            ...
            for frame in range(1, 5):  # Load frames 1, 2, 3, 4
                try:
                    ...
                    escalator_sprite_rgba = self.jr.loadFrame(escalator_sprite_path)
        ...
        try:
            moneybag_sprite_rgba = self.jr.loadFrame(moneybag_sprite_path)
        ...
        try:
            ...
            suitcase_sprite_rgba = self.jr.loadFrame(suitcase_sprite_path)
        ...
        try:
            ...
            obstacle_sprite_rgba = self.jr.loadFrame(obstacle_sprite_path)
        ...
        try:
            ...
            shopping_cart_sprite_rgba = self.jr.loadFrame(shopping_cart_sprite_path)
        ...
        try:
            ...
            kop_standing_rgba = self.jr.loadFrame(kop_standing_path)
        ...
        for frame in range(1, 5):
            try:
                ...
                sprite_rgba = self.jr.loadFrame(kop_running_left_path)
        ...
        for frame in range(1, 5):
            try:
                ...
                sprite_rgba = self.jr.loadFrame(thief_running_right_path)
        ...
        try:
            ...
            ball_sprites_raw['ball_air'] = self.jr.loadFrame(ball_air_path)
        except Exception as e:
            pass
        ...
        try:
            ...
            ball_sprites_raw['ball_bounce'] = self.jr.loadFrame(ball_bounce_path)
        except Exception as e:
            pass
            # Fallback to simple white circle
    ...
    @partial(jax.jit, static_argnums=(0,))
    def _get_escalator_sprite_frame(self, state: KeystoneKapersState) -> chex.Array:
