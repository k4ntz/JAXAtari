from jaxatari.games.jax_montezuma_utils import *
...
def make_demo_layout(LAYOUT: PyramidLayout, consts) -> PyramidLayout:
    ...
    ROOM_3_0.set_field(field_name=VanillaRoomFields.sprite.value,
                     field_type=NamedTupleFieldType.OTHER_ARRAY,
                     content=loadFrameAddAlpha(fileName=os.path.join(SPRITE_PATH, "bonus_room_sprite.npy"), transpose=True),
                     requires_serialisation=False)
    ROOM_3_0.set_field(field_name=VanillaRoomFields.room_collision_map.value,
                     field_type=NamedTupleFieldType.OTHER_ARRAY,
                     content=load_collision_map(fileName=os.path.join(SPRITE_PATH,"bonus_room_collision_map.npy"),as_bool=False, transpose=True),
                     requires_serialisation=False)
    ...
    ROOM_3_7.set_field(field_name=VanillaRoomFields.sprite.value, 
                     field_type=NamedTupleFieldType.OTHER_ARRAY, 
                     content=loadFrameAddAlpha(fileName=os.path.join(SPRITE_PATH, "pitroom.npy"), transpose=True), 
                     requires_serialisation=False)
    ROOM_3_7.set_field(field_name=VanillaRoomFields.room_collision_map.value, 
                     field_type=NamedTupleFieldType.OTHER_ARRAY, 
                     content=load_collision_map(fileName=os.path.join(SPRITE_PATH, "pitroom_collision_map.npy"), as_bool=False, transpose=True), 
                     requires_serialisation=False)
...
def make_difficulty_1(LAYOUT: PyramidLayout, consts) -> PyramidLayout:
        ...
        rope_0 = Rope(
            x_pos=jnp.array([72], dtype=jnp.int32),
            top=jnp.array([49], dtype=jnp.int32),
...
def make_difficulty_2(LAYOUT: PyramidLayout, consts) -> PyramidLayout:
        ...
        conveyor_0 = ConveyorBelt(
            ...
            y=jnp.array([89], dtype=jnp.int32),
            movement_dir=jnp.array([MovementDirection.LEFT.value], dtype=jnp.int32),
            color=jnp.array([ObstacleColors.DIF_1_LAYER_2_PRIMARY.value],jnp.int32)
        )
