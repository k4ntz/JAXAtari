...
class DoubleDunk(JaxEnvironment[DunkGameState, DunkObservation, DunkInfo, DunkConstants]):
    ...
    def _init_state(self, key) -> DunkGameState:
        ...
        return DunkGameState(
            ...
            ball=BallState(x=0.0, y=0.0, vel_x=0.0, vel_y=0.0, holder=PlayerID.PLAYER1_INSIDE, target_x=0.0, target_y=0.0, landing_y=0.0, is_goal=False, shooter_id=PlayerID.NONE, receiver_id=PlayerID.NONE),
            player_score=0,
            enemy_score=0,
            step_counter=0,
    ...
    def _handle_ball_actions(self, state: DunkGameState, actions: Tuple[int, ...], key: chex.PRNGKey) -> Tuple[BallState, chex.PRNGKey]:
        ...
        ball_state = jax.lax.cond(
            ...
            lambda b: b.replace(
                ...
                is_goal=is_goal, shooter_id=shooter_id, receiver_id=PlayerID.NONE
            ),
            lambda b: b,
            ball_state
        )
