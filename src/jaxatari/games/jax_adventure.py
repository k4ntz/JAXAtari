    ...
    def observation_space(self) -> spaces:
        return spaces.Dict({
            ...
            "dragon_yellow": spaces.Dict({
                ...
                "y": spaces.Box(low=0, high=250, shape=(), dtype=jnp.int32),
                "tile": spaces.Box(low=0, high=30, shape=(), dtype=jnp.int32),
                "width": spaces.Box(low=self.consts.DRAGON_SIZE[0], high=self.consts.DRAGON_SIZE[0], shape=(), dtype=jnp.int32),
                "height": spaces.Box(low=self.consts.DRAGON_SIZE[1], high=self.consts.DRAGON_SIZE[1], shape=(), dtype=jnp.int32),
                "state": spaces.Box(low=0, high=5, shape=(), dtype=jnp.int32),
            }),
            "dragon_green": spaces.Dict({
                "x": spaces.Box(low=0, high=160, shape=(), dtype=jnp.int32),
                "y": spaces.Box(low=0, high=250, shape=(), dtype=jnp.int32),
                "tile": spaces.Box(low=0, high=30, shape=(), dtype=jnp.int32),
                "width": spaces.Box(low=self.consts.DRAGON_SIZE[0], high=self.consts.DRAGON_SIZE[0], shape=(), dtype=jnp.int32),
            ...
            "key_yellow": spaces.Dict({
                ...
                "y": spaces.Box(low=0, high=250, shape=(), dtype=jnp.int32),
                "tile": spaces.Box(low=0, high=30, shape=(), dtype=jnp.int32),
                "width": spaces.Box(low=self.consts.KEY_SIZE[0], high=self.consts.KEY_SIZE[0], shape=(), dtype=jnp.int32),
                "height": spaces.Box(low=self.consts.KEY_SIZE[1], high=self.consts.KEY_SIZE[1], shape=(), dtype=jnp.int32),
                "state": spaces.Box(low=0, high=5, shape=(), dtype=jnp.int32),
            }),
            "key_black": spaces.Dict({
                "x": spaces.Box(low=0, high=160, shape=(), dtype=jnp.int32),
                "y": spaces.Box(low=0, high=250, shape=(), dtype=jnp.int32),
                "tile": spaces.Box(low=0, high=30, shape=(), dtype=jnp.int32),
                "width": spaces.Box(low=self.consts.KEY_SIZE[0], high=self.consts.KEY_SIZE[0], shape=(), dtype=jnp.int32),
            ...
            "gate_yellow": spaces.Dict({
                "x": spaces.Box(low=0, high=160, shape=(), dtype=jnp.int32),
                "y": spaces.Box(low=0, high=250, shape=(), dtype=jnp.int32),
                "tile": spaces.Box(low=0, high=30, shape=(), dtype=jnp.int32),
                "width": spaces.Box(low=self.consts.GATE_SIZE[0], high=self.consts.GATE_SIZE[0], shape=(), dtype=jnp.int32),
                "height": spaces.Box(low=self.consts.GATE_SIZE[1], high=self.consts.GATE_SIZE[1], shape=(), dtype=jnp.int32),
                "state": spaces.Box(low=0, high=5, shape=(), dtype=jnp.int32),
            }),
            "gate_black": spaces.Dict({
                "x": spaces.Box(low=0, high=160, shape=(), dtype=jnp.int32),
                "y": spaces.Box(low=0, high=250, shape=(), dtype=jnp.int32),
                "tile": spaces.Box(low=0, high=30, shape=(), dtype=jnp.int32),
                "width": spaces.Box(low=self.consts.GATE_SIZE[0], high=self.consts.GATE_SIZE[0], shape=(), dtype=jnp.int32),
            ...
            "sword": spaces.Dict({
                ...
                "y": spaces.Box(low=0, high=250, shape=(), dtype=jnp.int32),
                "tile": spaces.Box(low=0, high=30, shape=(), dtype=jnp.int32),
                "width": spaces.Box(low=self.consts.SWORD_SIZE[0], high=self.consts.SWORD_SIZE[0], shape=(), dtype=jnp.int32),
                "height": spaces.Box(low=self.consts.SWORD_SIZE[1], high=self.consts.SWORD_SIZE[1], shape=(), dtype=jnp.int32),
                "state": spaces.Box(low=0, high=5, shape=(), dtype=jnp.int32),
            }),
            "bridge": spaces.Dict({
                "x": spaces.Box(low=0, high=160, shape=(), dtype=jnp.int32),
                "y": spaces.Box(low=0, high=250, shape=(), dtype=jnp.int32),
                "tile": spaces.Box(low=0, high=30, shape=(), dtype=jnp.int32),
                "width": spaces.Box(low=self.consts.BRIDGE_SIZE[0], high=self.consts.BRIDGE_SIZE[0], shape=(), dtype=jnp.int32),
                "height": spaces.Box(low=self.consts.BRIDGE_SIZE[1], high=self.consts.BRIDGE_SIZE[1], shape=(), dtype=jnp.int32),
                "state": spaces.Box(low=0, high=5, shape=(), dtype=jnp.int32),
            }),
            "magnet": spaces.Dict({
                "x": spaces.Box(low=0, high=160, shape=(), dtype=jnp.int32),
                "y": spaces.Box(low=0, high=250, shape=(), dtype=jnp.int32),
                "tile": spaces.Box(low=0, high=30, shape=(), dtype=jnp.int32),
                "width": spaces.Box(low=self.consts.MAGNET_SIZE[0], high=self.consts.MAGNET_SIZE[0], shape=(), dtype=jnp.int32),
                "height": spaces.Box(low=self.consts.MAGNET_SIZE[1], high=self.consts.MAGNET_SIZE[1], shape=(), dtype=jnp.int32),
                "state": spaces.Box(low=0, high=5, shape=(), dtype=jnp.int32),
            }),
            "chalice": spaces.Dict({
                "x": spaces.Box(low=0, high=160, shape=(), dtype=jnp.int32),
                "y": spaces.Box(low=0, high=250, shape=(), dtype=jnp.int32),
                "tile": spaces.Box(low=0, high=30, shape=(), dtype=jnp.int32),
                "width": spaces.Box(low=self.consts.CHALICE_SIZE[0], high=self.consts.CHALICE_SIZE[0], shape=(), dtype=jnp.int32),
                "height": spaces.Box(low=self.consts.CHALICE_SIZE[1], high=self.consts.CHALICE_SIZE[1], shape=(), dtype=jnp.int32),
                "state": spaces.Box(low=0, high=5, shape=(), dtype=jnp.int32),
            }),
            "bat": spaces.Dict({
                "x": spaces.Box(low=0, high=160, shape=(), dtype=jnp.int32),
                "y": spaces.Box(low=0, high=250, shape=(), dtype=jnp.int32),
                "tile": spaces.Box(low=0, high=30, shape=(), dtype=jnp.int32),
                "width": spaces.Box(low=0, high=0, shape=(), dtype=jnp.int32),
            ...
            "key_yellow": spaces.Dict({
                ...
                "y": spaces.Box(low=0, high=250, shape=(), dtype=jnp.int32),
                "tile": spaces.Box(low=0, high=30, shape=(), dtype=jnp.int32),
                "width": spaces.Box(low=self.consts.DOT_SIZE[0], high=self.consts.DOT_SIZE[0], shape=(), dtype=jnp.int32),
                "height": spaces.Box(low=self.consts.DOT_SIZE[1], high=self.consts.DOT_SIZE[1], shape=(), dtype=jnp.int32),
                "state": spaces.Box(low=0, high=5, shape=(), dtype=jnp.int32),
            })
